 ...
 * Documents. The parser supports single document structures as also collections
 * of documents (data element).
 * <p>
...
public class ImixsJSONParser {
     ...
     * <p>
     * The method supports both - a single document (item element) or a collection
     * of documents (data element). In both cases the method returns a collection of
     * ItemCollections
     * 
     * Example-1: <code>
     *  {
